...
const Detail = ({ postDetails }: any) => {
  ...
  return (
    <div className="flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap overflow-hidden">
      <div className="relative flex-2 w-[2200px] lg:w-[11/12] flex justify-center items-center bg-gray-800">
      ...
      <div className="relative w-full overflow-auto">
        <div className="lg:mt-20 mt-10">
          ...
          <p className="mt-8 px-10 text-lg text-gray-600">{post.caption}</p>
